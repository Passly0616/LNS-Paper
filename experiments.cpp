...
int runAllExperiments() {
    ...
    // 表1：总体实验
    {
        ...
        writeOverall("table1_overall.csv", table);
    }
    ...
    // 表8：配对统计数据
    {
        ...
        writePaired("table8_paired_results.csv", rows);
    }
    ...
    // 表3：不同期限宽松系数
    {
        ...
        writeByBeta("table3_by_beta.csv", rows);
    }
    ...
    // 表4：不同惩罚系数
    {
        ...
        writeByLambda("table4_by_lambda.csv", rows);
    }
    ...
    // 表5：LNS 消融
    {
        ...
        writeAblation("table5_ablation.csv", table);
    }
    ...
    // 表6：扩展规模（较大 k 主实验）
    {
        ...
        writeByK("table6_extended_k.csv", rows);
    }
    ...
    // 表7：小规模精确最优对比
    {
        ...
        writeExact("table7_exact_gap.csv", rows);
    }
